...
## Addressing System Rules
- Toute adresse doit être déterministe et réversible
- Le calcul GPS doit stocker la précision et la source
- Aucun PlusCode brut ne doit être affiché côté utilisateur
## Mobile API Rules
- Toutes les routes API sont sous /api
- Auth obligatoire (JWT / OAuth2)
